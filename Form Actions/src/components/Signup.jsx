...
function signupAction(prevFormState, formData){
  ...
  const acquisitionChannel = formData.getAll('acquisition'); //getAll
  ...
  if(!isNotEmpty(password) || !hasMinLength(password,6) ){
    errors.push('Must Provide a password with at least six characters.');
  }

  if(!isEqualToOtherValue(password, confirmPassword)){
    errors.push('Passwords must same');
  }

  if(!isNotEmpty(firstName) || !isNotEmpty(lastName)){
    errors.push('Provide your first name and last name.');
  }
  if(!isNotEmpty(role)){
    ...
    <form action={formAction}>
      ...
      <div className="control">
        ...
        <input 
          ...
          {/* defaultValue to preserve Resetting */}
      </div>
      ...
      <fieldset>
        ...
        <div className="control">
          <input
            ...
            name="acquisition"
            value="google"
            defaultChecked = {formState.enteredValues?.acquisitionChannel.includes('google')} //defaultChecked
          />
